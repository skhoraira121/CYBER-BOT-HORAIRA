...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "HORAIRA") || (event.body.toLowerCase() == "Horaira bai") || (event.body.toLowerCase() == "@──HORAIRA➝😘😈😈🩶🪽2️⃣0️⃣2️⃣5️⃣󱢏 ッ") || (event.body.toLowerCase() == হোরায়রা")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ HORAIRA ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 horaira.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/61575092731225/posts/pfbid0XEfwRcjg616mnAFT3HutRWnp4dK4unDkssc1dduymtwbS5SPNeU8H3LS32fFppvCl/\nতার সাতে যোগা যোগ করবেন WhatsApp :- +017014890**", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:HORAIRA❤️ হাই আমি মেছেন্জার ROBOT  আামার বস হোরায়রা আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is HORAIRA ッ❤️ তাকে সবাই হোরায়রা নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami HORAIRA") || (event.body.toLowerCase() == "cup sala ami HORAIRA") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "সুমনা") || (event.body.toLowerCase() == "@ফু'ল প্রে'মি'কা ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস হোরায়রা এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "sumona") || (event.body.toLowerCase() == "moni")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস হোরায়রা এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "সুমনা") || (event.body.toLowerCase() == "সুমনা")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস হোরায়রা এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "ফু'ল প্রে'মি'কা") || (event.body.toLowerCase() == "ফু'ল প্রে'মি'কা")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস হোরায়রা এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Sazzad Hasan ") || (event.body.toLowerCase() == "Rafsan")) {
     return api.sendMessage("🥰-রাফসান-🌺 আমার বস হোরায়রা'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম হুম করবি না মাথা এমনিতেই গরম আছে🤬⛏️😷", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami horaira") || (event.body.toLowerCase() == "kire")) {
